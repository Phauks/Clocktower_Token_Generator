/**
 * Projects Management Hook - Refactored Version
 *
 * This is a refactored version of useProjects demonstrating the use of:
 * - handleAsyncOperation from errorUtils
 * - logger from utils
 * - Cleaner error handling patterns
 *
 * TO APPLY: Rename this file to useProjects.ts (backup the original first)
 */
