...
import { assetStorageService } from '../../services/upload/index';
import { loadStudioAsset } from '../../ts/studio/assetIntegration';
import type { AssetWithUrl } from '../../services/upload/types';
import type { AssetType } from '../../services/upload/types';
    ...
    async (asset: AssetWithUrl) => {
      try {
        ...
        if (loadedData) {
          ...
          console.log('[AssetBrowser] Loaded asset:', loadedData);
        ...
        console.error('[AssetBrowser] Failed to load asset:', err);
  ...
  const handleDeleteAsset = useCallback(
    async (assetId: string, assetName: string) => {
      ...
      try {
        ...
        console.error('[AssetBrowser] Failed to delete asset:', err);
