...
export function PresetSection({
  ...
  const handleDeleteCustomPreset = useCallback(
    ...
    [deleteCustomPreset, getCustomPresets, onCustomPresetsChange, activePresetId, showConfirm, closeConfirm, addToast]
  )
  ...
  const handleUpdateCustomPreset = useCallback(
    ...
    [updateCustomPreset, getCustomPresets, onCustomPresetsChange, showConfirm, closeConfirm, addToast]
  )
  ...
  const handleImportFile = useCallback(
    ...
    [importPreset, getCustomPresets, onCustomPresetsChange]
  )
          ...
          {BUILT_IN_PRESETS.map(({ name, icon }) => {
            ...
            return (
              <PresetCard
                ...
                onMenuToggle={() =>
                  setActivePresetMenu(activePresetMenu === name ? null : name)
                }
                ...
                menuItems={[
                  ...
                  },
                  {
                    ...
                    description: isDefault ? 'Remove as startup preset' : 'Load this preset on startup',
